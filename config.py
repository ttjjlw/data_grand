...
class DefaultConfig():
    ...
    seed = 777
    best_score = 0
    model = 'RCNN1'  # 使用的模型，名字必须与models/__init__.py中的名字一致
    ...
    train_path = r'D:\localE\code\git\DaGuang\data_set\train_filter_num_line03.pkl'
    test_path = r'D:\localE\code\git\DaGuang\data_set\test_filter_num_line03.pkl'
    embedding_path = r'D:\localE\code\git\DaGuang\data_set\embeddings300_3000001.pkl'
    embedding_dim = 100  # 占位设置,具体的在数据预处理上设置
    data_line_shuffle = True
    vocab_size = 10000  # 占位设置，具体的在数据预处理上设置
